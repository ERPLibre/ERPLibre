...
from script.config.config_file import (CONFIG_FILE, CONFIG_OVERRIDE_FILE,
                                       LOGO_ASCII_FILE)
from script.todo.todo import (ANDROID_DIR, ENABLE_CRASH, ERROR_LOG_PATH,
                              GRADLE_FILE, MOBILE_HOME_PATH, STRINGS_FILE,
                              TODO, VENV_ERPLIBRE)
