...
# Les dépôts que Google Repo rapatrie sous script/ portent leur propre norme et
# leur propre Python : le dépôt ne répond pas de leur source. Même liste que
# l'extend-exclude de .ruff.toml, pour que balayer un répertoire à la main
# juge exactement ce que le formatage touche.
EXCLU = re.compile(
    r"(^|/)(\.git|\.venv[^/]*|node_modules|\.repo|__pycache__|addons"
    r"|OCA_maintainer-tools|OCA_odoo-module-migrator)/"
)
