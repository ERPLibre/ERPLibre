...
"""
    ...
    def _ssh_config_drop_hosts(content, names):
        ...
        Deux règles, chacune empêchant une perte de données.
    ...
    def _ssh_jump_depth(cls, cible, maxi=12):
        ...
        dispose de l'extérieur. Elle est exacte pour les hôtes dont ce
        fichier écrit lui-même l'entrée, à un ProxyJump par étage.
    ...
    def _monitoring_restore(self, zip_path):
        ...
        Un nom qui porte « neutralize » ne prouve rien : la base peut
        n'avoir aucun `database.is_neutralized`, garder des dizaines de
        crons actifs et son domaine de courriel d'origine. Poser la
